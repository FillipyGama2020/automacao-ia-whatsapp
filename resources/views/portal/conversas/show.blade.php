<x-portal-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            <a href="{{ route('portal.conversas.index') }}" class="text-gray-400 hover:text-gray-600">
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-4">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('portal.conversas.responder', $conversa) }}">
                    @csrf
                ...
                @if ($conversa->status === 'transferida_humano')
                    <form method="POST" action="{{ route('portal.conversas.retomar-ia', $conversa) }}" class="mt-3">
                        @csrf
